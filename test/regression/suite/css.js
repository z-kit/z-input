module.exports = {
  ...
  box: (browser) => {
    browser
      .url('http://localhost:6006/iframe.html?selectedKind=CSS%20component&selectedStory=box')
      .waitForElementPresent('.z-input', 1000)
  ...
  borderless: (browser) => {
    browser
      .url('http://localhost:6006/iframe.html?selectedKind=CSS%20component&selectedStory=borderless')
      .waitForElementPresent('.z-input', 1000)
  ...
  'prefix and suffix': (browser) => {
    browser
      .url('http://localhost:6006/iframe.html?selectedKind=CSS%20component&selectedStory=prefix%20and%20suffix')
      .waitForElementPresent('.z-input', 1000)
  ...
  dark: (browser) => {
    browser
      .url('http://localhost:6006/iframe.html?selectedKind=CSS%20component&selectedStory=dark')
      .waitForElementPresent('.z-input', 1000)
