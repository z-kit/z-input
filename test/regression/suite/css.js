...
test('CSS component - box', (t) => {
  ...
  return Nightmare()
    .goto('http://localhost:6006/iframe.html?id=css-component--box')
    .wait('.z-input')
...
test('CSS component - borderless', (t) => {
  ...
  return Nightmare()
    .goto('http://localhost:6006/iframe.html?id=css-component--borderless')
    .wait('.z-input')
...
test('CSS component - prefix and suffix padding', (t) => {
  ...
  return Nightmare()
    .goto('http://localhost:6006/iframe.html?id=css-component--prefix-and-suffix')
    .wait('.z-input')
...
test('CSS component - disabled input', (t) => {
  ...
  const expected = 0;
  return Nightmare()
    .goto('http://localhost:6006/iframe.html?id=css-component--disabled-input')
    .wait('.z-input')
    .evaluate(() => {
...
test('CSS component - manual label open', (t) => {
  t.plan(1);
  const msg = 'should render properly';
  const expected = '-8px';
  return Nightmare()
    .goto('http://localhost:6006/iframe.html?id=css-component--manual-label')
    .wait('.z-input')
...
test('CSS component - manual label closed', (t) => {
  t.plan(1);
  const msg = 'should render properly';
  const expected = '16px';
  return Nightmare()
